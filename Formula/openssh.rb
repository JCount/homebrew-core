class Openssh < Formula
  ...
  def install
    ...
    # Remove automatically generated host keys to prevent the users
    # of each platform getting the same bottled keys. Instead,
    # add a post_install step to regenerate them locally
    rm_f Dir[etc/"ssh/ssh_host*"]
  end
